...
\usepackage{chemgreek}          % Para letras gregas direitas em química
...
\usepackage[final,nopatch=footnote]{microtype} 			% para melhorias de justificação
...
%      comando \selectlanguage{brazilian} e 
...
\include{USPSC-TA-Textual/USPSC-Cap2-Fundamentacao_Teorica}

\include{USPSC-TA-Textual/USPSC-Cap3-Metodologia}

\include{USPSC-TA-Textual/USPSC-Cap4-Avaliacao_Experimental}

\include{USPSC-TA-Textual/USPSC-Cap5-Conclusao}
% ---
